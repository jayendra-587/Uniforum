...
if(!$_POST){
    ...
    $get_topic_res = mysqli_query($conn, $get_topic_sql) or die(mysqli_error($conn));
    ...
    $update_topic_sql = "UPDATE uf_threads SET Title = '".$clean_topic_title ."' WHERE TopicId =".$_SESSION["topic_id"];
    $update_topic_res = mysqli_query($conn, $update_topic_sql) or die(mysqli_error($conn));
